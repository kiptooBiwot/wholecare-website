<template>
  <div class="bg-[#213f9a] h-auto text-white p-10">
    <div class="container mx-auto md:flex space-y-5 py-10 md:space-y-0 gap-5">
      <div class="md:w-1/3">
        <div class="md:w-3/4 my-auto leading-loose space-y-4">
          ...
          <h4
            class="uppercase text-[#edda32] text-sm tracking-wider font-semibold"
          >
            24-Hour Phone Line
          </h4>
          <div>
          ...
          <div class="flex items-center">
            ...
            <div>sharon@wholecaresolutions.com.au</div>
          </div>
        </div>
      </div>
      <div class="md:w-1/3 my-auto">
        <h4
          class="uppercase text-[#edda32] text-sm tracking-wider font-semibold text-center"
        >
          Quick Links
        </h4>
        <div
      ...
      <div class="md:w-1/3 my-auto space-y-10">
        <h4
          class="uppercase text-[#edda32] text-sm tracking-wider font-semibold text-center"
        >
          Social Media
        </h4>
        <div class="flex items-center order-1 md:order-3">
          <div v-for="(icon, index) in icons" :key="index" class="mx-auto">
    ...
    <div class="container">
      <div class="mx-auto">
        <div class="text-center my-2 mx-auto">
          <a href="https://wa.me/+254723114297" target="_blank">
            <span
              class="font-semibold text-blue-200 text-xs hover:text-[#edda32] transition duration-700 ease-in-out"
